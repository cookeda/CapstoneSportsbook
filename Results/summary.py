...
def process_ratings(rating, type, league):
    if type == "cover" and league == 'NBA':
        return rating * 5
    elif type == "total" and league == 'NBA':
        return (rating/6) * 10
    else:
        return "Unknown"
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        while i < len(lines):
            ...
            if "Cover Rating" in line and "Over Score" in line:
                ...
                cover_grade = process_ratings(cover_rating, 'cover', 'NBA')

                total_rating = process_ratings(over_score, 'total', 'NBA')
