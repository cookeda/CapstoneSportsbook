...
# Usage
merge_and_save_data('Clean/NBA/Best.json', 'Clean/NBA/Best.json', 'Clean/Combined/Best Odds.json')
merge_and_save_data('Clean/MLB/Aggregate.json', 'Clean/MLB/Aggregate.json', 'Clean/Combined/Aggregate.json')
